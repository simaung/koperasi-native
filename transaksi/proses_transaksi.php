...
// SIMPAN
$kode_simpan		= isset($_POST['kode_simpan']);
$tgl_simpan			= isset($_POST['tgl_simpan']);
...
{
	$ambil=mysqli_fetch_array(mysqli_query($koneksi,"SELECT * FROM t_simpan where kode_anggota='$kode_anggota' and jenis_simpan='wajib' order by kode_simpan desc "));
...
$tgl_entry			= $_POST['tgl_entri'];

// PINJAM
$kode_pinjam		= isset($_POST['kode_pinjam']);
$tgl_pinjam			= isset($_POST['tgl_pinjam']);
$kode_jenis_pinjam	= isset($_POST['kode_jenis_pinjam']);
$besar_pinjaman		= isset($_POST['besar_pinjaman']);
$besar_angsuran		= isset($_POST['besar_angsuran']);
$lama_angsuran		= isset($_POST['lama_angsuran']);
$u_entry			= isset($_POST['u_entry']);
$tgl_entri			= $_POST['tgl_entri'];


// ANGSUR
$kodekodean=isset($_POST['kode_pinjam']);
$tgl_angsur			= isset($_POST['tgl_angsur']);
$angsuran_ke		= isset($_POST['angsuran_ke']);
$sisa_angsuran		= isset($_POST['sisa_angsuran']);
$sisa_pinjaman		= isset($_POST['sisa_pinjaman']);
$u_entry			= isset($_POST['u_entry']);
$tgl_entri			= isset($_POST['tgl_entri']);
$besarangsu			= isset($_POST['besar_angsur']);
$denda				= isset($_POST['denda']);
...
$pros=$_GET['pros'];
	...
	switch($pros){
		case "simpan"	:
							$qtambah=mysqli_query($koneksi,"INSERT INTO t_simpan VALUES('','$jenis_simpan','$besar_simpanan','$kode_anggota','$user_entri','$banding','$tgl_entry')");
