...
?>
<?php
		$query="SELECT max(kode_jenis_simpan) as KodeTerbesar FROM t_jenis_simpan";
		...
		$No_Urut++;
		$huruf='S';
		$kode_jenis_simpan=$huruf . sprintf("%04s", $No_Urut);
...
<div class="form-group">
 ...
 <input type="text" class="form-control" name="kode_jenis_simpan" size="54" value="<?php echo $kode_jenis_simpan;?>" readonly/>
</div>
<div class="form-group">
...
<?php
		...
		$kode = isset($_GET['kode_jenis_simpan']) ? $_GET['kode_jenis_simpan'] : '';
