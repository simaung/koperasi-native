...
<div class="row mt">
 ...
 <div class="form-panel" style="border-left:5px solid#d9534f;border-right:5px solid#d9534f;">
  ...
  <div class="form-panel" style="border-left:5px solid#d9534f;border-right:5px solid#d9534f;">
    <h4 style="color:#d9534f;">Master Petugas</h4>
    <p>Berisi data Petugas, admin dapat menambahkan mengedit atau menghapus</p>
    <p>Saat Menambah Petugas otomatis nama petugas tersubut akan menjadi username dan password sebagai operator</p>
  </div>
  <div class="form-panel" style="border-left:5px solid#d9534f;border-right:5px solid#d9534f;">
