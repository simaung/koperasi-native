...
$pdf->SetX(4); 
$pdf->MultiCell(19.5,0.6,'  " KOPERASI SIMPAN PINJAM FAMILY "',0,'L');
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.6,'  KAMPUNG MUARA RW.01 DESA BANJARAN WETAN ',0,'L');
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.6,' KECAMATAN BANJARAN KABUPATEN BANDUNG ',0,'L');
