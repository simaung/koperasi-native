...
?>
    	...
    	<tr>
            ...
            $d=$data['kode_anggota'];
			$f=mysqli_fetch_array(mysqli_query($koneksi,"SELECT nama_anggota from t_anggota where Kode_anggota='$d'"));
			$rty=mysqli_fetch_array(mysqli_query($koneksi,"SELECT sum(besar_simpanan) as total_asli from t_simpan where Kode_anggota='$d'"));
            ...
            <td align="center">
			<a class="btn btn-primary btn-xs" href="index.php?pilih=1.3&aksi=viewhistory&kode_tabungan=<?php echo $data['kode_tabungan'];?>&kode_anggota=<?php echo $d;?>"><i class="fa fa-dollar"></i> Histori</a>
            <a class="btn btn-danger btn-xs" href="index.php?pilih=1.3&aksi=viewambil&kode_tabungan=<?php echo $data['kode_tabungan'];?>&kode_anggota=<?php echo $d;?>"><i class="fa fa-dollar"></i> Ambil Uang</a>
			</td>
        </tr> 
...
<div class="row mt">
    ...
    <form action="anggota/proses_tabungan.php" method="get">
      <div class="form-group">
        ...
        <div class="form-group">
            <label>Saldo</label>
            <?php $rtyu=mysqli_fetch_array(mysqli_query("SELECT *FROM t_tabungan where kode_tabungan='$lo' and kode_anggota='$luy'")); ?>
...
?>
      ...
      <td><?php echo $no;?></td>
			...
			$f=mysqli_fetch_array(mysqli_query($koneksi,"SELECT nama_anggota from t_anggota where Kode_anggota='$d'")); 
			$rty=mysqli_fetch_array(mysqli_query($koneksi,"SELECT sum(besar_simpanan) as total_asli from t_simpan where Kode_anggota='$d'"));
			$inves=$rtyu['besar_tabungan']-$rty['total_asli'];?>
            <td><?php echo $f['nama_anggota'];?></td>
...
{ 
	...
	$nama=mysqli_fetch_array(mysqli_query($koneksi,"SELECT nama_anggota from t_anggota where Kode_anggota='$luy'"));
...
<div class="row mt">
                <div class="col-lg-12">
                    <div class="form-panel">
                    <h4 class="mb"><span class='glyphicon glyphicon-briefcase'></span> Laporan Simpanan Tabungan Uang "<?php echo $ang['nama_anggota'];?>" 
                    <?php
						...
						<?php $rtyu=mysqli_fetch_array(mysqli_query($koneksi,"SELECT *FROM t_tabungan where kode_tabungan='$lo' and kode_anggota='$luy'")); ?>
						 Total Tabungan = <?php echo $rtyu['besar_tabungan'];?>
...
{ 
 ...
 {
 	$baru=mysqli_fetch_array(mysqli_query($koneksi,"SELECT *FROM t_simpan where kode_anggota='$kode' and jenis_simpan='wajib' order by kode_simpan desc "));
 	
	//$baru=mysqli_query($koneksi,"SELECT *FROM t_simpan where kode_anggota='$kode' and jenis_simpan='wajib' order by kode_simpan desc ");
...
$nama=mysqli_fetch_array(mysqli_query($koneksi,"SELECT nama_anggota from t_anggota where Kode_anggota='$luy'")); ?>
 ...
 <div class="col-lg-12">
  <div class="form-panel">
   <h4 class="mb"><span class='glyphicon glyphicon-briefcase'></span> Laporan Pengambilan Tabungan Uang "<?php echo $nama['nama_anggota']; ?>" 
   <?php
                        $at=mysqli_query($koneksi,"SELECT * FROM t_pengambilan where kode_anggota='$luy'");
                        $jut=mysqli_num_rows($at);
						echo'<kbd style="background-color:#d9534f;">'.$jut.'</kbd>';?>
