...
<?php
		$query="SELECT max(kode_jenis_pinjam) as KodeTerbesar FROM t_jenis_pinjam";
		...
		$No_Urut++;
		$huruf='S';
		$kode_jenis_pinjam=$huruf . sprintf("%04s", $No_Urut);
...
<div class="form-group">
 ...
 <input type="text" class="form-control" name="kode_jenis_pinjam" size="54" value="<?php echo $kode_jenis_pinjam;?>" readonly/>
</div>
<div class="form-group">
...
<?php
		...
		$kode = isset($_GET['kode_jenis_pinjam']) ? $_GET['kode_jenis_pinjam'] : '';
