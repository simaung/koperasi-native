 <?php
          $itong_pinjam=mysql_num_rows(mysql_query("SELECT*from t_pinjam where kode_anggota='$kode'"));
          $itong_angsur=mysql_num_rows(mysql_query("SELECT*from t_angsur where kode_anggota='$kode'"));
          $itong_simpan=mysql_num_rows(mysql_query("SELECT*from t_simpan where kode_anggota='$kode'"));
          $c=mysql_fetch_array(mysql_query("SELECT SUM(besar_pinjam) as total_pinjam from t_pinjam where kode_anggota='$kode'"));
          $d=mysql_fetch_array(mysql_query("SELECT SUM(besar_angsuran) as total_angsuran from t_angsur where kode_anggota='$kode'"));
          $e=mysql_fetch_array(mysql_query("SELECT SUM(besar_simpanan) as total_simpan from t_simpan where kode_anggota='$kode'"));
