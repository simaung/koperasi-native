  ...
  <table class="table table-bordered table-striped table-condensed">
    <thead>
		<tr class="info">
             ...
             <th><a href="#">Jabatan</a></th>
			 <th><a href="#">Alamat</a></th>
             <th><a href="#">No Telepon</a></th>
...
?>
<?php
		$query="SELECT max(kode_petugas) as KodeTerbesar FROM t_petugas";
		...
		$No_Urut++;
		$huruf='P';
		$kode_petugas=$huruf . sprintf("%04s", $No_Urut);
...
<label>Kode Petugas</label>
 <input type="text" class="form-control" name="kode_petugas" size="54" value="<?php echo $kode_petugas;?>" readonly/>
</div>
<div class="form-group">
 <input type="hidden" class="form-control" name="kode_user" size="54" value="<?php if(!isset($_SESSION)){session_start();} echo $_SESSION['kopname'];?>" readonly/>
</div>
<div class="form-group">
...
<label>User Entri</label>
 <input type="text"  readonly class="form-control" name="u_entry" size="54" value="<?php if(!isset($_SESSION)){session_start();} echo $_SESSION['kopname'];?>"/>
</div>
<div class="form-group">
...
<div class="form-group">
<label>Jabatan</label>
 <input type="text" class="form-control" name="jabatan" size="54" value="<?php echo $data2['jabatan'];?>"/>
</div>
<div class="form-group">
<label>Alamat Petugas</label>
