...
<?php
		...
		//$kode=isset($_GET['kode_anggota']);
		$kode = isset($_GET['kode_anggota']) ? $_GET['kode_anggota'] : '';
		$query=mysqli_query($koneksi,"SELECT * FROM t_anggota WHERE kode_anggota='$kode'");
...
?>
<?php
		$query="SELECT max(kode_anggota) as KodeTerbesar FROM t_anggota";
		...
		$No_Urut++;
		$huruf='A';
		$kode_anggota=$huruf . sprintf("%04s", $No_Urut);
...
<div class="row mt">
				...
				<form action="anggota/proses_anggota.php?pros=tambah" method="post" id="form" role="form" enctype="multipart/form-data">
						  <div class="form-group">
                              ...
                              <input type="text" name="kode_anggota" class="form-control" size="54" value="<?php echo $kode_anggota;?>" readonly/>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                              <label>Simpanan Pokok</label>
                                <input type="text" name="simpanan_pokok" class="form-control" size="54" id="simpanan_pokok" class="required" readonly="" value="<?php echo $pokok;?>">
                          </div>
                          <div class="form-group">
